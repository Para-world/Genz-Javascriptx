...
const balance = new Number(100); // Number object (rarely zarurat hoti hai)
...
// -----------------------------------------
// BigInt (ES2020) — safe integer range se bade numbers ke liye
// -----------------------------------------

const bigNum = 9007199254740991n + 1n;
console.log("\nBigInt:", bigNum); // 9007199254740992n — precise!
// BigInt aur regular numbers mix nahi kar sakte: bigNum + 1 TypeError dega
...
console.log("Math.ceil(4.2):", Math.ceil(4.2));   // 5 (upar round karta hai)
console.log("Math.floor(4.9):", Math.floor(4.9)); // 4 (neeche round karta hai)
console.log("Math.trunc(4.9):", Math.trunc(4.9)); // 4 (decimal hata deta hai — ES2015)
console.log("Math.trunc(-4.9):", Math.trunc(-4.9)); // -4 (negatives me floor se alag!)
...
console.log("\n--- Random Numbers ---");
console.log("Math.random():", Math.random());                        // 0 se 0.999...
console.log("Random 1-10:", Math.floor(Math.random() * 10) + 1);    // 1 se 10

// Range me random number (inclusive)
const min = 10;
const max = 20;
...
// -----------------------------------------
// crypto.randomUUID() — Secure unique ID (Node 19+ / Browsers)
// -----------------------------------------

// Browsers aur Node.js 19+ me kaam karta hai
